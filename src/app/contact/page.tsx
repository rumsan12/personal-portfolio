    ...
    <>
      <div className="contact-card">
        ...
        <div className="social-icons">
          <a href="https://www.facebook.com/asal.poudel.1/">
            <FaFacebook />
          </a>
          <a href="https://www.instagram.com/asal_poudel/">
            <FaInstagram />
          </a>
          <a href="https://www.github.com/asal99">
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/asalpoudel/">
            <FaLinkedin />
          </a>
        </div>
      </div>
